...
public class Simulation {
  ...
  /**
   * hasEnded: is the simulation finished?
   * nextTaxi: number of the taxi to be use in next step
   */
  ...
  /**
   * simulation step:
   * if there are passengers load them in a taxi,
   * otherwise let a train bring new passengers,
   * or indicate that simulation stops
   */
  public void step() {
